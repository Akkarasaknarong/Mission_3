...
void display_Color_2()
{
    ...
    int average = (panel.getRaw(0) + panel.getRaw(1) + panel.getRaw(2) + panel.getRaw(3) + panel.getRaw(4) + panel.getRaw(5)) / 6;
    // Serial.println(average);
    if (panel.getRaw(0) > panel.getRaw(1) && panel.getRaw(0) > panel.getRaw(2))
    {
        digitalWrite(led_Blue, HIGH);
        digitalWrite(led_Red, LOW);
        digitalWrite(led_Green, LOW);
    }
    else if (panel.getRaw(2) > panel.getRaw(0) && panel.getRaw(2) > panel.getRaw(1))
    {
        digitalWrite(led_Blue, LOW);
        digitalWrite(led_Red, HIGH);
        digitalWrite(led_Green, LOW);
    }
    else if (panel.getRaw(1) > panel.getRaw(0) && panel.getRaw(1) > panel.getRaw(2))
    {
        digitalWrite(led_Blue, LOW);
        digitalWrite(led_Red, LOW);
        digitalWrite(led_Green, HIGH);
...
void TrackLine()
{
    ...
    {
        motor_Left.speed(183);
        motor_Right.speed(183);
    }
